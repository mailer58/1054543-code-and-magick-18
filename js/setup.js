...
function onPopupEscPress(evt) {
  if (evt.keyCode === ESC_KEYCODE && currentActiveElement != 'setup-user-name') {
    closePopup();
  }
}

function getActiveElement() {
  currentActiveElement = document.activeElement.className;
}
...
function openPopup() {
  ...
  setup.addEventListener('click', getActiveElement);
...
function closePopup() {
  ...
  setup.removeEventListener('click', getActiveElement);
